    ...
    <div class="flex items-center p-2 rounded-lg shadow-md">
        <div class="relative rounded-full p-1 shadow-inner">
            <div class="flex items-center justify-center ml-5">
                <img src="default.jpg" alt="Default Avatar" class="max-w-[80px] w-[70px] h-[60px] rounded-full" />
                <img src={`./borders/${userAvatarBorder}`} alt="Usuário" class="absolute rounded-full max-w-[100px] h-[80px]" />
            </div>
        </div>
        <div class="ml-2 flex flex-col items-start">
            ...
            <div class="relative w-24 h-2 bg-gray-600 rounded-full mt-1">
                ...
                <span class="absolute left-1/2 transform -translate-x-1/2 text-white text-xs top-1/2 -translate-y-1/2">Level {userLevel}</span>
            </div>
        </div>
